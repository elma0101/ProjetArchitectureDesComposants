...
public class SecurityMonitoringService {
    ...
    public void recordUnauthorizedAccess(String serviceName, String path) {
        suspiciousActivities.increment();
        logger.warn("SECURITY ALERT: Unauthorized access attempt - Service: {}, Path: {}", 
            serviceName, path);
    }
    
    public void recordInvalidServiceCredentials(String serviceName) {
        authenticationFailures.increment();
        suspiciousActivities.increment();
        logger.warn("SECURITY ALERT: Invalid service credentials from: {}", serviceName);
    }
