...
public class ResilienceConfig {
    ...
    public CircuitBreakerRegistry circuitBreakerRegistry() {
        ...
        registry.circuitBreaker("userManagementService").getEventPublisher()
    ...
    public RetryRegistry retryRegistry() {
        ...
        registry.retry("userManagementService").getEventPublisher()
            .onRetry(event -> 
    ...
    public TimeLimiterRegistry timeLimiterRegistry() {
        ...
        registry.timeLimiter("userManagementService").getEventPublisher()
            .onTimeout(event -> 
